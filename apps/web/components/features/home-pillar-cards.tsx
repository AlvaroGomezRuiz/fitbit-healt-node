  ...
  const nutricionPlanLine =
    diarioPlanHoy.state === "ok"
      ...
      : diarioPlanHoy.state === "no_plan"
        ? "Sin plan del día aún. Se rellena con el cron diario (~8:50 hora estándar Madrid, ver docs)."
    ...
    telemetriaLatest.state === "ok"
      ...
      : telemetriaLatest.state === "disabled"
        ...
        : telemetriaLatest.state === "empty"
          ? "Sin filas recientes de telemetría. Cuando sincronice, verás un resumen aquí."
